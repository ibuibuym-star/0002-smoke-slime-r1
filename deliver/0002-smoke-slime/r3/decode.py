...
# sprite encoding uses alphabet[1] for the first palette color ('1' == pal_hex[0])
pal = {ch: tuple(int(h[i:i+2], 16) for i in (1, 3, 5)) + (255,) for ch, h in zip(alphabet[1:], pal_hex)}
